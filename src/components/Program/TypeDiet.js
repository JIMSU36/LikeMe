    ...
    return(
        ...
        <div className="md:hidden block w-full h-full ">
            ...
            <div className="flex-col flex text-left text-sm font-semibold">
                <p>- 맞지 않는 다이어트로 힘들게 뺏다, 쪘다.</p>
                <p className="indent-3">반복의 악순환을 겪으시는 분.</p>
                <p className="mt-2">- 지속해서나에게 적합한 습관 다이어트를</p>
                <p className="indent-3">익히고 싶으신 분.</p>
                <p className="mt-2">- 운동도 하고 음식량도 적게 먹는데</p>
                <p className="indent-3">살이 잘 빠지지 않는 분.</p>
                <p className="mt-2">- 복부비만으로 미용적으로나 건강 쪽으로</p>
                <p className="indent-3">고생하고 있으신 분.</p>
                <p className="mt-2">- 자율신경계 시스템이 깨져</p>
                <p className="indent-3">기분 조절이나 불면증으로 힘드신 분.</p>
                <p className="mt-2">- 갑상선이 안 좋으시거나 림프, 정맥순환장애로,</p>
                <p className="indent-3">많이 부으시는 분.</p>
                <p className="mt-2">- 수험생이나 결혼 입시 등을 앞두고</p>
                <p className="indent-3">급찐급빠하시는 분.</p>
                <p className="mt-2">- 다이어트는 그때뿐</p>
                <p className="indent-3">항상 요요로 제자리걸음 하시는 분.</p>
            </div>
            ...
            <div className="flex-col flex text-left text-sm font-semibold">
                ...
                <span className="text-sm font-normal pl-4">
                    <p>필라테스를 기반으로 한 코어 운동과</p>
                    <p>맨몸 웨이트 트레이닝으로 </p>
                    <p>체형교정 및 체지방 감량 목적을 둔</p>
                    <p>운동 방법을 알려드립니다</p>
                </span>
                <Label className="pt-6">남성 회원</Label>
                <span className="text-sm font-normal pl-4">
                    <p>중량 웨이트 트레이닝과 코어 운동을 병행하여</p>
                    <p>근력 향상 및 균형을 위한 밸런스 트레이닝을</p>
                    <p>지도해 드리고 있습니다.</p>
                </span>
            </div>
