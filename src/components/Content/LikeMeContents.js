...
import Company from '../LikeMeTab/Company';
import Instructor from '../LikeMeTab/Instructor';
import CopCompany from '../LikeMeTab/CopCompany';
        ...
        <div id="5" name="5" className='content'>
            <div className='h-[30vh] w-full relative bg-gray-400'>
                <div className='h-auto w-full absolute top-[50%] translate-y-1/2'>
                    <Label className='w-full h-full m-auto text-center text-4xl text-white font-bold'>라이크미</Label>
                </div>
            </div>
