                    ...
                    <div className="absolute top-[50%] -translate-y-2/4 translate-x-[80%] z-[99] p-12 text-left text-white w-1/2">
                        <div className="flex flex-col">
                            ...
                            <span className="slide-text my-12 text-lg">
                                다이어트, 체형교정, 통증관리, 키성장, 체력관리의 목적에 따라 나에게 맞는 운동과 종류를 찾아드립니다.
                            </span>
                            <Button 
                ...
                <div className="slider2 h-[100vh]">
                    <div className="absolute top-[50%] -translate-y-2/4 translate-x-[80%] z-[99] p-12 text-left text-white w-1/2">
                        <div className="flex flex-col">
                            ...
                            <hr className="w-1/2 mt-4 mb-12 border-2 border-white"/>
                            <span className="slide-text my-12 text-lg">
                                <p>주먹구구식의 몸만 힘들게 하는 운동이 아닌 과학적 근거를 기반으로</p>
                                <p>8가지 유형의 원인 결과 시스템에 입각한 다이어트 프로그램을 맞춤 설계합니다.</p>
                            </span>
                            <Button 
                                className="bg-white hover:bg-white/[0.6] hover:text-black rounded-lg font-bold text-[#93AEF9] w-[10vw] h-[5vh] my-auto"
                                onClick={()=>{
                ...
                <div className="slider3 h-[100vh]">
                    <div className="absolute top-[50%] -translate-y-2/4 translate-x-[80%] z-[99] p-12 text-left text-white w-1/2">
                        <div className="flex flex-col">
                            ...
                            <hr className="w-1/2 mt-4 mb-12 border-2 border-white"/>
                            <span className="slide-text my-12 text-lg">
                                <p>개인체형 분석으로 장점은 부각, 단점은 완벽 커버해 드리고,</p>
                ...
                <div className="slider5 h-[100vh]">
                    <div className="absolute top-[50%] -translate-y-2/4 translate-x-[80%] z-[99] p-12 text-left text-white w-1/2">
                        <div className="flex flex-col">
                            ...
                            <hr className="w-1/2 mt-4 mb-12 border-2 border-white"/>
                            <span className="slide-text my-12 text-lg">
                                <p>검사해도 안나오고 여기저기가 아픈 분들,</p>
                                <p>통증분류와 원인별로 나눠 나에게 맞는 스트레칭과 근력, 밸런스 운동으로 케어받을 수 있는 프로그램입니다.</p>
                            </span>
                            <Button 
                                className="bg-white hover:bg-white/[0.6] hover:text-black rounded-lg font-bold text-[#93AEF9] w-[10vw] h-[5vh] my-auto"
                                onClick={()=>{
                ...
                <div className="slider6 h-[100vh]">
                    <div className="absolute top-[50%] -translate-y-2/4 translate-x-[80%] z-[99] p-12 text-left text-white w-1/2">
                        <div className="flex flex-col">
                            ...
                            <hr className="w-1/2 mt-4 mb-12 border-2 border-white"/>
                            <span className="slide-text my-12 text-lg">
                                <p>병원가니 일 좀 쉬라는 처방만 받고, 누적된 피로감으로</p>
                                <p>남은건 일자목과 일자허리이신 분들을 위한 내 몸을 지킬 수 있는 자세교정 프로그램입니다.</p>
                            </span>
                            <Button 
                                className="bg-white hover:bg-white/[0.6] hover:text-black rounded-lg font-bold text-[#93AEF9] w-[10vw] h-[5vh] my-auto"
                                onClick={()=>{
