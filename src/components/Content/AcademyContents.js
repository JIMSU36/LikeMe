...
const AcademyContents = () => {
    const [selectTab, setSelectTab] = useState("강사");
            ...
            <div className='w-full h-full bg-white relative '>
                <Nav className='w-full h-full flex space-x-6 text-lg justify-center border-b-2'>
                    <NavItem className='px-6 py-[2vh] h-full'>
                        <NavLink 
                            className={selectTab === "강사" ? "active cursor-pointer font-bold py-[2vh] border-b-4 border-gray-400" : "cursor-pointer " }
                            onClick={() => {
                                setSelectTab("강사")
                            }}
                        >
                    ...
                    <NavItem className='px-6 py-[2vh]'>
                        <NavLink 
                            className={selectTab === "트레이너" ? "active cursor-pointer font-bold py-[2vh] border-b-4 border-gray-400" : "cursor-pointer " }
                            onClick={() => {
                                setSelectTab("트레이너")
                            }}
                        >
